...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.example.CodingTask")).paths(PathSelectors.any()).build()
				.apiInfo(metaData());
	}
	/**
	...
	private ApiInfo metaData() {
		return new ApiInfoBuilder().title("Coding Task for CSV Data Load Documentation")
